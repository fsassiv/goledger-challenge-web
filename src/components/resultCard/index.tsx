...
export const ResultCard: FC<{ item: SchemBaseTypes }> = ({ item }) => {
  ...
  return (
    <Card className="mb-4 w-full md:w-[24%] md:mr-[1%] bg-neutral-600 border-0 flex flex-col justify-between p-2">
      ...
      <div>
        ...
        <CardFooter className="flex justify-between p-2">
          <Link href={`/item/${item['@key']}`}>
            <Button
              variant="outline"
              className="bg-neutral-950 text-orange-500 px-3 text-xs border-0"
            >
              Details
            </Button>
          </Link>
